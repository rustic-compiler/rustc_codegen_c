...
impl CModule {
    ...
    pub fn to_c_source(&self) -> String {
        ...
        s.push_str("#ifndef __RUSTC_CODEGEN_C_PREAMBLE\n");
        s.push_str("#define __RUSTC_CODEGEN_C_PREAMBLE\n");
        ...
        s.push_str("};\n");
        // Weak definition of the unwind chain pointer. The allocator module
        // (allocator.rs) emits a strong definition with default visibility
        // and the symbol is added to the linker export list, so when libstd
        // is a shared library all codegen units share a single TLS slot.
        ...
        s.push_str("#endif\n\n");
        s.push_str("#endif /* __RUSTC_CODEGEN_C_PREAMBLE */\n\n");
